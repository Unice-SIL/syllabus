...
var Syllabus = function (Syllabus) {
  ...
  */
  ...
  function tabLoaderInit() {
    $('main > .row:first-child > div > ul.nav').on('click', 'li.nav-item > a', function () {
