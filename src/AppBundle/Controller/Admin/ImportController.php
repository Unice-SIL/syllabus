...
use AppBundle\Import\Configuration\CourseInfoCsvConfiguration;
use AppBundle\Import\Configuration\CoursePermissionCsvConfiguration;
use AppBundle\Import\Configuration\UserCsvConfiguration;
