    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO course_info_field (field, label) 
                            VALUES (\'structure\', \'Structure\'), (\'title\', \'Titre\'), (\'ects\', \'Présentation / ECTS\'), (\'level\', \'Présentation / Niveau\'), (\'languages\', \'Présentation / Langages\'), (\'domain\', \'Présentation / Domaine\'), (\'semester\', \'Présentation / Semestre\'), (\'summary\', \'Présentation / Résumé\'),
                             ...
                             (\'teachingOtherHybridDist\', \'Présentation / Volume Autre (hybride/à distance)\'), (\'teachingOtherTypeHybridDistant\', \'Présentation / Type volume Autre (hybride/à distance)\'), (\'mccWeight\', \'MCC / Poids ECUE\'), (\'mccCompensable\', \'MCC / UE compensable\'), 
                             (\'mccCapitalizable\', \'MCC / UE capitalizable\'),
                             (\'mccCcCoeffSession1\', \'MCC / Session 1 - coefficient CC\'),(\'mccCcNbEvalSession1\', \'MCC / Session 1 - nb évaluation(s)\'), (\'mccCtCoeffSession1\', \'MCC / Session 1 - coefficient CT\'), (\'mccCtNatSession1\', \'MCC / Session 1 - nature CT\'), 
